...
#define GGML_MAX_CONTEXTS       2048 // Bump from 64 to allow loading split models that have more than 64 chunks - https://github.com/ggml-org/whisper.cpp/discussions/2520
