...
static const ggml_type_traits_t type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_IQ4_XXS] = {
        .type_name                = "iq4_xxs",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_iq4_xxs),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_iq4_xxs,
        .from_float               = quantize_row_iq4_xxs,
        .from_float_ref           = (ggml_from_float_t)quantize_row_iq4_xxs_ref,
        .vec_dot                  = vec_dot_iq4_xxs_q8_k,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
        .row_meta_size            = 4,
    },
...
enum ggml_type ggml_ftype_to_ggml_type(enum ggml_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case GGML_FTYPE_MOSTLY_IQ4_XXS:       wtype = GGML_TYPE_IQ4_XXS;  break;
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_IQ4_XXS: result = quantize_iq4_xxs(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
