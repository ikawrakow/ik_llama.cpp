...
static const ggml_type_traits_t type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_IQ4_KNN] = {
        .type_name                = "iq4_knn",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_iq4_knn),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_iq4_knn,
        .from_float               = quantize_row_iq4_knn,
        .from_float_ref           = (ggml_from_float_t)quantize_row_iq4_knn_ref,
        .vec_dot                  = vec_dot_iq4_knn_q8_k,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
        .row_meta_size            = 20,
    },
...
enum ggml_type ggml_ftype_to_ggml_type(enum ggml_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case GGML_FTYPE_MOSTLY_IQ4_KNN:       wtype = GGML_TYPE_IQ4_KNN;  break;
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_IQ4_KNN: result = quantize_iq4_knn(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
