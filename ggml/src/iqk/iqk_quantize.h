...
void   quantize_row_iq4_xxs_ref(const float * GGML_RESTRICT x, block_iq4_xxs  * GGML_RESTRICT y, int64_t k);
void   quantize_row_iq4_xxs(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
size_t quantize_iq4_xxs(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
void   dequantize_row_iq4_xxs(const block_iq4_xxs  * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
