...
enum ggml_metal_kernel_type {
    ...
    GGML_METAL_KERNEL_TYPE_GET_ROWS_IQ4_XXS,
    ...
    GGML_METAL_KERNEL_TYPE_MUL_MV_IQ4_XXS_F32,
  ...
  //GGML_METAL_KERNEL_TYPE_MUL_MV_ID_F16_F32_L4,
    ...
    GGML_METAL_KERNEL_TYPE_MUL_MV_ID_IQ4_XXS_F32,
    ...
    GGML_METAL_KERNEL_TYPE_MUL_MM_IQ4_XXS_F32,
    ...
    GGML_METAL_KERNEL_TYPE_MUL_MM_ID_IQ4_XXS_F32,
...
#define GGML_METAL_ADD_KERNEL(e, name, supported) \
        ...
        GGML_METAL_ADD_KERNEL(GGML_METAL_KERNEL_TYPE_GET_ROWS_IQ4_XXS,              get_rows_iq4_xxs,               true);
        ...
        GGML_METAL_ADD_KERNEL(GGML_METAL_KERNEL_TYPE_MUL_MV_IQ4_XXS_F32,            mul_mv_iq4_xxs_f32,             ctx->support_simdgroup_reduction);
      ...
      //GGML_METAL_ADD_KERNEL(GGML_METAL_KERNEL_TYPE_MUL_MV_ID_F16_F32_L4,          mul_mv_id_f16_f32_l4,           ctx->support_simdgroup_reduction);
        ...
        GGML_METAL_ADD_KERNEL(GGML_METAL_KERNEL_TYPE_MUL_MV_ID_IQ4_XXS_F32,         mul_mv_id_iq4_xxs_f32,          ctx->support_simdgroup_reduction);
        ...
        GGML_METAL_ADD_KERNEL(GGML_METAL_KERNEL_TYPE_MUL_MM_IQ4_XXS_F32,            mul_mm_iq4_xxs_f32,             ctx->support_simdgroup_mm);
        ...
        GGML_METAL_ADD_KERNEL(GGML_METAL_KERNEL_TYPE_MUL_MM_ID_IQ4_XXS_F32,         mul_mm_id_iq4_xxs_f32,          ctx->support_simdgroup_mm);
                ...
                case GGML_OP_MUL_MAT:
                    {
                        ...
                        if ([ctx->device supportsFamily:MTLGPUFamilyApple7] &&
                            ...
                            switch (src0->type) {
                                ...
                                case GGML_TYPE_IQ4_XXS: pipeline = ctx->kernels[GGML_METAL_KERNEL_TYPE_MUL_MM_IQ4_XXS_F32].pipeline; break;
                                ...
                                case GGML_TYPE_IQ4_XXS:
                                    {
                                        nth0 = 4;
                                        nth1 = 16;
                                        pipeline = ctx->kernels[GGML_METAL_KERNEL_TYPE_MUL_MV_IQ4_XXS_F32].pipeline;
                                    } break;
                            ...
                            if (src0t == GGML_TYPE_Q4_0  || src0t == GGML_TYPE_Q4_1  || src0t == GGML_TYPE_Q5_0 || src0t == GGML_TYPE_Q6_0 ||
                                ...
                                [encoder dispatchThreadgroups:MTLSizeMake((ne01 + 7)/8, ne11, ne12*ne13) threadsPerThreadgroup:MTLSizeMake(nth0, nth1, 1)];
                                     ...
                                     src0t == GGML_TYPE_IQ5_K  ||  src0t == GGML_TYPE_IQ6_K || src0t == GGML_TYPE_IQ4_XXS) {
                ...
                case GGML_OP_MUL_MAT_ID:
                    {
                        ...
                        if ([ctx->device supportsFamily:MTLGPUFamilyApple7] &&
                            ...
                            switch (src0->type) {
                                ...
                                case GGML_TYPE_IQ4_XXS: pipeline = ctx->kernels[GGML_METAL_KERNEL_TYPE_MUL_MM_ID_IQ4_XXS_F32].pipeline; break;
                                ...
                                case GGML_TYPE_IQ4_XXS:
                                    {
                                        nth0 = 4;
                                        nth1 = 16;
                                        pipeline = ctx->kernels[GGML_METAL_KERNEL_TYPE_MUL_MV_ID_IQ4_XXS_F32].pipeline;
                                    } break;
                                case GGML_TYPE_IQ2_K:
                                    {
                                        nth0 = 4;
                ...
                case GGML_OP_GET_ROWS:
                    {
                        ...
                        switch (src0->type) {
                            ...
                            case GGML_TYPE_IQ4_XXS: pipeline = ctx->kernels[GGML_METAL_KERNEL_TYPE_GET_ROWS_IQ4_XXS].pipeline; break;
