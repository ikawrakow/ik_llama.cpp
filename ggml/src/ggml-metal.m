        ...
        case GGML_OP_MUL_MAT_ID:
            {
                ...
                // !!!
                //printf("%s: ne00 = %d, dst_rows = %d, dst_rows_min = %d max = %d, ne20 = %d ne21 = %d\n", src0->name, (int)ne00, (int)dst_rows, (int)dst_rows_min, (int)dst_rows_max, (int)ne20, (int)ne21);
                if ([ctx->device supportsFamily:MTLGPUFamilyApple7] &&
                        ne00 % 32 == 0 && ne00 >= 64 &&
                        dst_rows > dst_rows_min &&
                        dst_rows <= dst_rows_max) {

                    //printf("Using mul_mm_id for %s\n", dst->name);
...
//                            [encoder dispatchThreadgroups:MTLSizeMake((ne21 + 31)/32, (ne01 + 63)/64, n_as) threadsPerThreadgroup:MTLSizeMake(128, 1, 1)];
//                        } else {
//                            //printf("Using gemv for mul_mat_id\n");
//                            int nth0 = 32;
//                            int nth1 = 1;
//                            int nrows = 1;
//                            //printf("vector: ne00 = %6d, ne01 = %6d, ne02 = %6d, ne11 = %6d, ne12 = %6d\n", ne00, ne01, ne02, ne11, ne12);
