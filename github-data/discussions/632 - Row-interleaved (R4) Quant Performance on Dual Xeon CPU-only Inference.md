### [Discussion #632](https://github.com/ikawrakow/ik_llama.cpp/discussions/632) - Row-interleaved (R4) Quant Performance on Dual Xeon CPU-only Inference
...
Yes, it used to be true that row-interleaved quants offer better PP performance. But then I optimized non-interleaved quants in PRs #531, #533, #534 (AVX2) and #549, #550, #552 (ARM_NEON), so now non-interleaved quants have a better PP performance.
