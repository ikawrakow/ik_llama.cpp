...
OK, I found the culprit. It is the change in warm up that was added in #198.

Basically, to improve the experience for MoE models, #198 changed the warm up to use all experts. But the warm up is being detected with this line of code
```
...
This should be fixed on latest main (after merging #639). You should not need to override the BOS token ID.
