...
// qwen4exp shared MTP companion: predictor-only drafters borrow the target's
// IO tensors. Internal helper for common/speculative.cpp — not public API,
// mirroring llama_model_share_dflash_io_tensors above.
